        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <h1 class="fw-bold mb-0">Modifier le Défi</h1>
                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" class="form-control ch-form-control py-3" value="<?= e($challenge->getTitle()) ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-4">
                            ...
                            <div class="col-12">
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" class="form-control ch-form-control" rows="6" required><?= e($challenge->getDescription()) ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="date" name="deadline" class="form-control ch-form-control py-3" value="<?= e($challenge->getDeadline()) ?>" required>
                                </div>
                            </div>
                            
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label small fw-bold">URL de l'Image d'Illustration</label>
                                    <input type="url" name="image" class="form-control ch-form-control py-3" value="<?= e($challenge->getImage()) ?>">
                                </div>
                            </div>

                            <div class="col-12 mt-5 text-center">
                                <button type="submit" class="btn ch-btn-charcoal px-5 py-3 fs-5">Enregistrer les Modifications</button>
                                <div class="mt-3">
                                    <a href="index.php?action=show_challenge&id=<?= $challenge->getId() ?>" class="text-muted text-decoration-none small">Annuler et revenir au défi</a>
                                </div>
                            </div>
                        </div>
                    </form>
